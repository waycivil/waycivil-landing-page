  ...
  return (
    <>
      <motion.div
        ...
        className={cn(
          "absolute left-0 top-20 m-auto h-14 w-px rounded-full bg-linear-to-t from-primary via-[#FA934B] to-transparent",
    ...
    <div {...props} className={cn("absolute z-50 h-2 w-2", props.className)}>
      ...
      {spans.map((span) => (
        <motion.span
          ...
          className="absolute h-1 w-1 rounded-full bg-linear-to-b from-primary to-[#FA934B]"
        />
      ))}
    </div>
  );
